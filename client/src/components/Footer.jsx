				...
				<Stack spacing={8} direction={{base: 'column', md: 'row'}} justify={'space-between'} py={{ base: '12', md: '16' }}>
					<Stack spacing={{ base: '6', md: '8' }} align='start'>
						<Flex alignItems='center'>
							<Icon as={BsPhoneFlip} h='10' w='10' mr={1} color={mode('black', 'red.200')} />
					...
					<Stack direction={{ base: 'column-reverse', md: 'column', lg: 'row' }} spacing={{ base: '12', md: '8' }}>
						...
						<Stack spacing={4}>
							...
							<Stack spacing={4} direction={{base: 'column', sm: 'row'}} maxWidth={{lg: '360px'}}>
								<Input placeholder='Enter your e-mail' type='email' required />
								<Button variant={'ghost'} type='submit' flexShrink={0}>Subscribe</Button>
							</Stack>
						</Stack>
					</Stack>
				</Stack>
